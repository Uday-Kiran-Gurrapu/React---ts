...
function Home() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Hero */}
      <div className="p-8 bg-gradient-to-br from-accent-900/40 to-gray-800 border border-accent-800/40 rounded-2xl">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="p-5 bg-gray-800 border border-gray-700 rounded-xl text-center">
          <p className="text-3xl font-bold text-accent-400">{step}</p>
          <p className="text-xs text-gray-500 mt-1 uppercase tracking-wide">Step Size</p>
        </div>
        <div className="p-5 bg-gray-800 border border-gray-700 rounded-xl text-center">
          <p className="text-3xl font-bold text-accent-400">{count > 0 ? "+" : "—"}</p>
      ...
      <div className="flex flex-col items-center gap-5 p-8 bg-gray-800 border border-gray-700 rounded-2xl">
        ...
        <p className="text-7xl font-bold text-accent-400 tabular-nums">{count}</p>
